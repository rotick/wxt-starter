const locales = [
  ...
  { code: 'zh-hans', iso: 'zh', name: '简体中文', file: 'zh-hans.json' },
  { code: 'es', iso: 'es', name: 'Español', file: 'es.json' },
  { code: 'zh-hant', iso: 'zh-TW', name: '正體中文', file: 'zh-hant.json' },
  ...
  { code: 'ms', iso: 'ms', name: 'Bahasa Malaysia', file: 'ms.json' },
  { code: 'vi', iso: 'vi', name: 'Tiếng Việt', file: 'vi.json' },
  { code: 'th', iso: 'th', name: 'ไทย', file: 'th.json' },
